...
const PaymentBogResponse = () => {
  ...
  const redirectStatus = searchParams.get('status'); // 'success' or 'fail' from BOG redirect
  ...
  useEffect(() => {
    ...
    const checkOrder = async () => {
      try {
        // Wait for BOG webhook to process
        ...
        const isSuccess = order.payment_status === 'paid' || redirectStatus === 'success';
...
export default PaymentBogResponse;
